...
public class TestSalonDeBellezaDataBaseApplication {
    ...
    public static void main(String[] args) {
        SpringApplication.from(SalonDeBellezaDataBaseApplication::main).with(TestSalonDeBellezaDataBaseApplication.class).run(args);
    }
